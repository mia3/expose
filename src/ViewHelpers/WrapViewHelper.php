...
class WrapViewHelper extends AbstractViewHelper
{
    ...
    public function render()
    {
        ...
        if ($this->viewHelperVariableContainer->exists('Flowpack\Expose\ViewHelpers\WrapViewHelper',
            $this->arguments['name'])
        ) {
            $wraps = $this->viewHelperVariableContainer->get('Flowpack\Expose\ViewHelpers\WrapViewHelper',
                $this->arguments['name']);
