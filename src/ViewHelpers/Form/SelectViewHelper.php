...
class SelectViewHelper extends AbstractTagBasedViewHelper
{
    ...
    public function initializeArguments()
    {
        ...
        $this->registerArgument('optionValueField', 'string',
            'If specified, will call the appropriate getter on each object to determine the value.');
        $this->registerArgument('optionLabelField', 'string',
            'If specified, will call the appropriate getter on each object to determine the label.');
        $this->registerArgument('options', 'mixed',
            'Associative array or object with internal IDs as key, and the values are displayed in the select box',
            true);
